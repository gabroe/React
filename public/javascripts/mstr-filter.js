...
angular.module('mstr.filter', [])
    ...
    .controller('FilterCtrl', function ($scope, $modalInstance, $filter) {
        ...
        this.isSelectorAvailable = function (type) {
            ...
            if (type === 0 && !model.defn[model.header[this.selectedIndex]]) {
                return ($filter('unique')(this.model.rows, selectedIndex)).length < 10;
            }

            return model.defn[model.header[this.selectedIndex]] == type;
        };
    });